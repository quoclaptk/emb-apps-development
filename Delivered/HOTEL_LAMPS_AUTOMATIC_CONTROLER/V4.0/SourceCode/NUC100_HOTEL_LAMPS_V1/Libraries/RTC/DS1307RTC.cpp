 ...
 */
void DS1307_RTC::setClockHalt(uint8_t halt)
{
 ...
 */
uint8_t DS1307_RTC::getClockHalt(void)
{
 ...
 */
void DS1307_RTC::setRegByte(uint8_t regAddr, uint8_t val)
{
 ...
 */
uint8_t DS1307_RTC::getRegByte(uint8_t regAddr)
{
    uint8_t val;
 ...
 */
void DS1307_RTC::setEnableSquareWave(DS1307_SquareWaveEnable mode)
{
 ...
 */
void DS1307_RTC::setInterruptRate(DS1307_Rate rate)
{
    uint8_t controlReg = getRegByte(DS1307_REG_CONTROL);
 ...
 */
uint8_t DS1307_RTC::getDayOfWeek(void)
{
 ...
 */
uint8_t DS1307_RTC::getDate(void)
{
 ...
 */
uint8_t DS1307_RTC::getMonth(void)
{
 ...
 */
uint16_t DS1307_RTC::getYear(void)
{
 ...
 */
uint8_t DS1307_RTC::getHour(void)
{
 ...
 */
uint8_t DS1307_RTC::getMinute(void)
{
 ...
 */
uint8_t DS1307_RTC::getSecond(void)
{
 ...
 */
int8_t DS1307_RTC::getTimeZoneHour(void)
{
 ...
 */
uint8_t DS1307_RTC::getTimeZoneMin(void)
{
 ...
 */
void DS1307_RTC::setDayOfWeek(uint8_t dayOfWeek)
{
 ...
 */
void DS1307_RTC::setDate(uint8_t date)
{
 ...
 */
void DS1307_RTC::setMonth(uint8_t month)
{
 ...
 */
void DS1307_RTC::setYear(uint16_t year)
{
 ...
 */
void DS1307_RTC::setHour(uint8_t hour_24mode)
{
 ...
 */
void DS1307_RTC::setMinute(uint8_t minute)
{
 ...
 */
void DS1307_RTC::setSecond(uint8_t second)
{
 ...
 */
void DS1307_RTC::setTimeZone(int8_t hr, uint8_t min)
{
 ...
 */
uint8_t DS1307_RTC::decodeBCD(uint8_t bin)
{
 ...
 */
uint8_t DS1307_RTC::encodeBCD(uint8_t dec)
{
