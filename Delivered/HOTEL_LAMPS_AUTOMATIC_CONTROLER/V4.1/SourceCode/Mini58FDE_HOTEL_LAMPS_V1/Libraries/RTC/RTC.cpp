...
//    masterTransmit(DS1307_ADDR, bytes, 2);
	SW_I2C_UTIL_WRITE(SW_I2C1, DS1307_ADDR, regAddr, val);
}
...
//    masterReceive(DS1307_ADDR, &val, 1);
    return SW_I2C_UTIL_Read(SW_I2C1, DS1307_ADDR, regAddr);
//    return SW_I2C_ReadControl_8Bit(SW_I2C1, DS1307_ADDR, regAddr);;
}
